...
export const metadata: Metadata = {
  title: "Our Services",
  description:
    "Explore ByteNodes comprehensive range of services including game server hosting, VPS solutions, custom bot development, and professional website services.",
  openGraph: {
          ...
          <div className="mt-16 text-center">
            <Card className="p-8 bg-gradient-to-r from-primary/10 to-primary/5 border-primary/20">
              ...
              <p className="text-muted-foreground mb-6 max-w-2xl mx-auto">
                Tim kami siap membantu Anda menemukan solusi hosting yang tepat
