    ...
    <div className="min-h-screen">
      ...
      >
        ...
        <div className="container mx-auto text-center relative z-10">
          ...
          {/* Category Toggle */}
          <div className="inline-flex flex-wrap items-center justify-center gap-2 bg-card rounded-lg p-1.5 shadow-lg border border-border/50 backdrop-blur-sm max-w-full">
            <button
              onClick={() => setSelectedCategory("web-ptero")}
              className={`px-3 sm:px-4 py-2.5 rounded-md text-xs sm:text-sm font-semibold transition-all whitespace-nowrap ${
        ...
        <div className="container mx-auto">
          ...
          {selectedCategory === "dev-service" ? (
            <div className="max-w-lg mx-auto">
              <div>
                <Card className="p-8 border-primary shadow-lg border-2 bg-gradient-to-b from-card via-card to-primary/5 relative">
            ...
            <div
              className={`grid ${
                selectedCategory === "web-ptero"
                  ...
                  : "md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5 max-w-full"
              } gap-6 mx-auto`}
            >
              {(selectedCategory === "web-ptero"
                ? webPteroPackages
