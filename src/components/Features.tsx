...
const features = [
  {
    ...
    description:
      "Perlindungan DDoS canggih dan sertifikat SSL disertakan di setiap paket.",
  },
  {
    icon: Zap,
    title: "Sangat Cepat",
    description:
      "Penyimpanan SSD dan infrastruktur yang dioptimalkan untuk performa maksimal.",
  },
  {
    icon: HeadphonesIcon,
    title: "Dukungan 24/7",
    description:
      "Tim support teknis ahli tersedia setiap saat untuk membantu Anda.",
  },
  {
    icon: TrendingUp,
    title: "Mudah Upgrade",
    description:
      "Tingkatkan resource dengan mudah seiring pertumbuhan bisnis Anda.",
  },
];
      ...
      <div className="container mx-auto">
        ...
        >
          ...
          <p className="text-base text-foreground/60 max-w-2xl mx-auto">
            Kami menyediakan infrastruktur tingkat enterprise dengan
            fleksibilitas dan dukungan yang bisnis Anda butuhkan
          </p>
        </motion.div>
