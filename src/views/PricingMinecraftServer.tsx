...
const minecraftContent: GameContent = {
...
export default function PricingMinecraftServer() {
  return <PricingGameServerShell game="minecraft" content={minecraftContent} />;
}
